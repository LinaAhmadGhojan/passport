			        ...
			        <div class="tab-pane fade show active" id="orders-all" role="tabpanel" aria-labelledby="orders-all-tab">
					    ...
					    <div class="app-card app-card-orders-table shadow-sm mb-5">
						    ...
						    <div class="app-card-body" style="background-color: #ffd333;">
								...
								color: white;
								text-align: center;">table information orders</h4>
							        ...
							        <table class="table app-table-hover mb-0 text-left">
										<thead>
											<tr style="background-color: #febb25;" >
												...
												<th class="cell">personal picture</th>
												<th class="cell">passport picture </th>
												<th class="cell">date birthday </th>
												<th class="cell">gender</th>
												<th class="cell">date issue   </th>
												<th class="cell">date expiry </th>
												<th class="cell"> profession   </th>
												<th class="cell">organization </th>
												<th class="cell">visa duration   </th>
												<th class="cell">date arrival    </th>
										...
										<tbody>
                                            ...
                                            <tr style="background-color: rgb(39, 37, 37);;">
                                                ...
                                                <td class="cell"><span class="truncate">
                                                    <img style="height: 100px;width: 100px" src="{{ asset('image/personal') }}/{{ $item->personal_picture }}" alt="">
                                                </td>
                                                <td class="cell"><span class="truncate">
                                                    <img style="height: 100px;width: 100px" src="{{ asset('image/passport') }}/{{ $item->passport_picture }}" alt="">
                                                </td>
												<td class="cell">{{ $item->date_birthday }}</td>
												<td class="cell"><span>{{ $item->gender }}</span></td>
												<td class="cell"> {{ $item->date_issue }} </td>
												<td class="cell">{{ $item->date_expiry }}</td>
												<td class="cell">{{ $item->profession }}</td>
												<td class="cell">{{ $item->organization }}</td>
												<td class="cell">{{ $item->visa_duration }}</td>
												<td class="cell">{{ $item->date_arrival }}</td>
