                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-md-6 mx-auto">
                                    ...
                                    <form action="{{ route('admin.post.send.invitation')}}" method="POST">
                                        @csrf
                                    <div class="card">
                                        <br><br>
                                        <div class="card-body">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                @endif
                                                <label for="password" class="form-label">Write Email :</label>
                                                <input name="email" required type="email" class="form-control" id="password" aria-describedby="emailHelp">
                                            </div>
                                            <br><br>
